...
const FooterSection: FC = () => (
    <Footer className="rounded-none">
        <div className="w-full ">
            ...
            <div className="w-full dark:bg-gray-800 border-t border-gray-600 py-6 px-4 sm:flex sm:items-center sm:justify-between">
                <Footer.Copyright by="Palmverse™" year={new Date().getFullYear()} />
